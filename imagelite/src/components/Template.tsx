...
export const Template: React.FC<TemplateProps> = ({ children, loadind }: TemplateProps) => {
    return (
        <>
            <Header/>
            <div className={`${loadind ? 'animate-pulse' : ''} container mx-auto mt-8 px-4`}>
                <RenderIf condition={loadind}>
    ...
    return (
        <footer className="bg-indigo-950 text-white py-4 mt-8">
            <div className="container mx-auto text-center">
                &copy; Desenvolvido por Jackson Valvenark
            </div>
        </footer>
    )
}